namespace Fill_UserControl_DropDownList
{
    ...
    [Table("pubmrg")]
    public partial class pubmrg
    {
        [Key]
        public int fill_id { get; set; }
        ...
        [StringLength(15)]
        public string mrgperflng { get; set; }
        ...
        [StringLength(110)]
        public string wlastfirst { get; set; }
        ...
        [StringLength(2)]
        public string mrgperfhours { get; set; }

        [StringLength(2)]
        public string mrgperfminutes { get; set; }

        [StringLength(2)]
        public string mrgperftimefrmt { get; set; }
    }
}
