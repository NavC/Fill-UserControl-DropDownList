namespace Fill_UserControl_DropDownList
{
    ...
    [Table("pubppc")]
    public partial class pubppc
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public pubppc()
        {
            pubppcpersons = new HashSet<pubppcperson>();
        }
        ...
        public int? not_county_id { get; set; }

        [StringLength(50)]
        public string not_lastname { get; set; }

        [StringLength(30)]
        public string not_firstname { get; set; }

        [StringLength(30)]
        public string not_middlename { get; set; }

        [StringLength(7)]
        public string not_commission_number { get; set; }

        public DateTime? not_expiration_date { get; set; }

        public int? ps { get; set; }

        public int? ps_county_id { get; set; }

        [StringLength(25)]
        public string ps_filenumber { get; set; }

        public DateTime? ps_expiration_date { get; set; }
        ...
        public virtual ICollection<pubppcperson> pubppcpersons { get; set; }
    }
}
