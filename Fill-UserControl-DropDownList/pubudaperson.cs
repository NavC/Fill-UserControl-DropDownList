namespace Fill_UserControl_DropDownList
{
    ...
    [Table("pubudaperson")]
    public partial class pubudaperson
    {
        [Key]
        public int udaperson_id { get; set; }

        public int? uda_id { get; set; }
        ...
        public DateTime? personexp_date { get; set; }

        [StringLength(30)]
        public string personident { get; set; }

        [StringLength(30)]
        public string personident_number { get; set; }
        ...
        public virtual pubuda pubuda { get; set; }
    }
}
